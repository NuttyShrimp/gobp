...
func NewPgxPool(options PSQLOptions) (*pgxpool.Pool, error) {
	...
	pgConfig.ConnConfig.Database = defaultString(options.Database, "gobp")
	pgConfig.ConnConfig.User = defaultString(options.User, "postgres")
	pgConfig.ConnConfig.Password = defaultString(options.Password, "password")
